      ...
      <div class="neumorphism-card-modal">
        ...
        <form @submit.prevent="saveCountry" novalidate>
          <div class="mb-3">
            ...
            <input id="name" v-model="formData.Name" class="neumorphism-input" required />
          </div>
  
          <div class="mb-3">
            <label for="continent" class="form-label">Continente</label>
            <select id="continent" v-model="formData.Continent" class="neumorphism-input" required>
          ...
          <div class="mb-4">
            ...
            <input id="language" v-model="formData.Language" class="neumorphism-input" required />
          </div>
  
          <div class="d-flex gap-2">
            <button type="submit" class="neumorphism-button-normal-blue">Guardar</button>
            <button type="button" class="neumorphism-button-normal-red" @click="cancel">Cancelar</button>
          </div>
        </form>
      </div>
